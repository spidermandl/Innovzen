...
public abstract class ExecutorAsyncTask<Params, Progress, Result> {
	 ...
	 */
	public static final Executor SERIAL_EXECUTOR = Util.hasHoneycomb() ? new SerialExecutor() : Executors.newSingleThreadExecutor(sThreadFactory);
	...
	/**
	 * Override this method to perform a computation on a background thread. The specified parameters are the parameters passed to {@link #execute} by the caller of this task. This method can call {@link #publishProgress} to publish updates on the UI thread.
	 * 
	 * @param params
	 ...
	 */
	public final ExecutorAsyncTask<Params, Progress, Result> execute(Params... params) {
	 ...
	 * @see #execute(Object[])
	 */
	public final ExecutorAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
