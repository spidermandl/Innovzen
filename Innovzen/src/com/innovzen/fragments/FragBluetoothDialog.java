...
public class FragBluetoothDialog extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.bluetooth_device_list, container,
				false);
		pairedListView = (ListView) view.findViewById(R.id.paired_devices);
		mPairedDevicesArrayAdapter = new ArrayAdapter<String>(
				this.getActivity(), R.layout.bluetooth_device_name);
		// mNewDevicesArrayAdapter = new
		// ArrayAdapter<String>(this.getActivity(),R.layout.bluetooth_device_name);
		...
		// view.findViewById(R.id.new_devices);
		...
		if (pairedDevices.size() > 0) {
			view.findViewById(R.id.title_paired_devices).setVisibility(
					View.VISIBLE);
